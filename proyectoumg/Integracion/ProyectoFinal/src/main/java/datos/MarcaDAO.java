...
public class MarcaDAO {
    ...
    private static final String SQL_SELECT = "SELECT idMarca, Nombre_marca, Descripcion_marca";
    ...
    private static final String SQL_DELETE = "DELETE FROM marca WHERE pkid=?";
    private static final String SQL_QUERY = "SELECT idMarca, Nombre_marca, Descripcion_marca FROM marca WHERE idMarca = ?";
